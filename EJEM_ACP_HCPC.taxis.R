...
row.names(base)[rango[1:10]]
base[which(row.names(base)=="1329730"),1:22]
base[which(row.names(base)=="363607"),1:22]
####
...
res.pca<-PCA(base,
quali.sup=c(1,2,16,17,18,19,20),quanti.sup= c(3:6,15,21,22),ncp=2,graph=FALSE) 
?HCPC
